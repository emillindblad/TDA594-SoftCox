...
public class VCS_GFGun_LVH_DH_FWHH_BWHH extends AbstractVCS_GFgun {
  public VCS_GFGun_LVH_DH_FWHH_BWHH(Enemy enemy) {
    super(enemy);
  }
  protected void SetUp() {
    ...
    //bins_.UseKnownSlices(Segmentation.BCK_WALL_HIT_TIME, Segmentation.HIGH_SEGMENTATION);
  }
  public String Name() {
